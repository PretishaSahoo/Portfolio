    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] mx-auto py-8 bg-black">
      ...
      <div className="col-span-2 px-5 mx-auto my-auto">
        ...
        <div className="col-span-1 my-auto mx-auto p-4 flex space-x-4">
          <a href=" https://www.linkedin.com/in/pretisha-sahoo/" target="_blank" rel="noopener noreferrer" className="text-blue-600">
          ...
          <a href="https://github.com/PretishaSahoo" target="_blank" rel="noopener noreferrer" className="text-gray-800">
            <svg className="w-6 h-6" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
